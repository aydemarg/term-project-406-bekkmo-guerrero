...
#Medals Distribution 
ggplot(olympics_viz, aes(x = medals_per_million)) +
...
#GDP per capital
ggplot(olympics_viz, aes(x = log_gdp)) +
  geom_histogram(bins = 30, fill = "steelblue", color = "white") +
  labs(
...
#Population
ggplot(olympics_viz, aes(x = log_population)) +
  geom_histogram(bins = 30, fill = "steelblue", color = "white") +
  labs(
...
ggplot(olympics_viz, aes(x = log_gdp, y = medals_per_million)) +
...
#relationship 
ggplot(olympics_viz, aes(x = log_population, y = medals_per_million)) +
  geom_point(alpha = 0.4) +
  geom_smooth(method = "lm", se = FALSE) +
  labs(
